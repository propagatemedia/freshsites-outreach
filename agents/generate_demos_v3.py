...
{about_html}
    ...
    <div style="position:relative;max-width:900px;margin:0 auto">
      ...
      <div class="tiers">
        <div class="tier">
          ...
          <a href="https://buy.stripe.com/14AaENc4oeYBgfk26R5EY0f" class="btn">Buy - £149</a>
        </div>
        <div class="tier featured">
          ...
          <a href="https://buy.stripe.com/fZu4gpecw2bPbZ4dPz5EY0g" class="btn">Buy - £399</a>
        </div>
        <div class="tier">
          <h4>Premium</h4>
  ...
  <div class="confirm-overlay" id="co">
    <div class="confirm-box">
      ...
      <div style="display:flex;gap:12px;justify-content:center">
        ...
        <button class="btn" onclick="doDel()" style="background:#666">Delete Demo</button>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function doDel(){{document.getElementById('co').classList.remove('active');document.getElementById('bb').style.display='none';document.getElementById('tp').classList.remove('active');alert('Demo removed. Contact FreshSites if you change your mind.')}}
    document.getElementById('cf').addEventListener('submit',function(e){{e.preventDefault();document.getElementById('cf').style.display='none';document.getElementById('sf').style.display='block'}});
